...
def validate_task_state_styles(index_html: str, errors: list[str]) -> None:
    try:
        ...
        state_consistency_checks = {
            ...
            "Focus mode entry must be independent of the overflow menu": ('id="focusModeToggleBtn"', 'aria-pressed="false"', 'id="focusModeToggleText"', "DOM.focusModeToggleBtn.addEventListener('click', toggleFocusMode)", "function syncFocusModeButton()"),
