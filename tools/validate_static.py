...
def validate_task_state_styles(index_html: str, errors: list[str]) -> None:
    try:
        ...
        state_consistency_checks = {
            ...
            "Import preview must include template restore checks": ("downloadPreImportSnapshot(beforeTasks)", "sourceInfo: getImportSourceInfo(sourceData, migrations)", "function getImportSourceInfo(sourceData, migrations = [])", "checksumStatus", "function createImportRestoreChecklist(preview, t)", "messages.import.restoreCheckTitle", "function createImportDiffPreview(preview, t)"),
