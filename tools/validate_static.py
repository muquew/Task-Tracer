...
def validate_task_state_styles(index_html: str, errors: list[str]) -> None:
    try:
        ...
        state_consistency_checks = {
            ...
            "Import preview must include template restore checks": ("sourceInfo: getImportSourceInfo(sourceData)", "function getImportSourceInfo(sourceData)", "hasTemplate", "function createImportRestoreChecklist(preview, t)", "messages.import.restoreCheckTitle"),
